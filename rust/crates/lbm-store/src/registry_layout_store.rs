...
pub fn read_global_options<K: RegistryKey>(root: &K, layout_key: Option<&K>) -> GlobalOptionsDto {
    ...
    GlobalOptionsDto {
        ...
        touch_all_displays: try_get_bool(root, "TouchAllDisplays"),
        touch_display_ids: try_get_string(root, "TouchDisplayIds"),
        touch_override_modifier: try_get_string(root, "TouchOverrideModifier"),
        focus_keep_apps: try_get_string(root, "FocusKeepApps"),
        focus_restore_apps: try_get_string(root, "FocusRestoreApps"),
