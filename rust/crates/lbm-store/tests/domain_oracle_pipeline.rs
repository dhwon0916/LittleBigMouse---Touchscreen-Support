...
fn options(layout: &Layout) -> Value {
    ...
    json!({
        ...
        "TouchAllDisplays": o.touch_all_displays,
        "TouchDisplayIds": o.touch_display_ids,
        "TouchOverrideModifier": o.touch_override_modifier,
        "FocusKeepApps": o.focus_keep_apps,
        "FocusRestoreApps": o.focus_restore_apps,
        "Priority": o.priority,
